...
EXECUTION_CHILD_ADAPTERS = config(
    ...
    default=(
        ...
        '"supervisor":"modules.execution.runtime.supervisor:execute_supervisor"},'
...
EXECUTION_CANCEL_GRACE_SECONDS = config(
    'EXECUTION_CANCEL_GRACE_SECONDS', default=2.0, cast=float)
EXECUTION_WORKER_MAX_CHILDREN = config(
    'EXECUTION_WORKER_MAX_CHILDREN', default=3, cast=int)
