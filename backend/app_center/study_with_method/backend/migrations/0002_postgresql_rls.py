...
TENANT_TABLES = (
    "study_workspaces",
    "study_profiles",
    "study_subject_enrollments",
    "study_tasks",
    "study_problems",
    "study_attempts",
    "study_mistakes",
    "study_review_schedules",
    "study_knowledge_masteries",
    "study_guardian_links",
    "study_weekly_reports",
)
...
class Migration(migrations.Migration):
    dependencies = [("study_with_method", "0001_initial")]
