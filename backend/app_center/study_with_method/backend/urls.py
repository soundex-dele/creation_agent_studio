...
urlpatterns = [
    ...
    path("applications/<int:application_id>/study/goals", views.GoalListView.as_view(), name="goals"),
    path("applications/<int:application_id>/study/diagnostics", views.DiagnosticListView.as_view(), name="diagnostics"),
    path("applications/<int:application_id>/study/diagnostics/<uuid:assessment_id>/submit", views.DiagnosticSubmitView.as_view(), name="diagnostic-submit"),
